from src import fighters


def test_all():
    f = fighters.fighter("/fighters/details/3263/")
...
def test_no_club():
    f = fighters.fighter("/fighters/details/12059/")
...
def test_no_nationality():
    f = fighters.fighter("/fighters/details/16895/")
    assert f["name"] == "Gabriel Gallegos"
    assert f["nationality"] == None
    assert f["club_id"] == "1167"

def test_only_name():
    f = fighters.fighter("/fighters/details/17021/")
